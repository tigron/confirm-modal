	...
	$.fn.confirmModal = function() {
		...
		$(this).click(function(ev) {
			...
			if (bootstrap_version == '3') {
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<a class="btn btn-primary" href="%%btn_href%%" id="data-confirm-ok">%%btn_ok%%</a>
									<a class="btn btn-default" data-dismiss="modal" aria-hidden="true" id="data-confirm-cancel">%%btn_cancel%%</a>
								</div>
							</div>
						</div>
					</div>
				...
				template = `
					<div id="dataConfirmModal" class="modal fade" aria-labelledby="dataConfirmLabel" tabindex="-1">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
								...
								<div class="modal-footer">
									<a class="btn btn-primary" href="%%btn_href%%" id="data-confirm-ok">%%btn_ok%%</a>
									<a class="btn btn-secp,dary" data-bs-dismiss="modal" aria-hidden="true" id="data-confirm-cancel">%%btn_cancel%%</a>
								</div>
							</div>
						</div>
					</div>
